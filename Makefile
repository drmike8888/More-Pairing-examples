...
bbs_signature: bbs_signature.c modulo.o eliptic.o poly.o poly_eliptic.o pairing.o signature.o
	gcc -o bbs_signature bbs_signature.c  modulo.o eliptic.o poly.o poly_eliptic.o pairing.o signature.o -lgmp -lk12
